# -*- coding: utf-8 -*-
"""
Created on Fri Nov  8 14:44:09 2019
...
def Scaler(dataMat):
    std_process = preprocessing.StandardScaler().fit(dataMat)
    Data_Scaler = std_process.transform(dataMat)
    return Data_Scaler
...
if __name__ == '__main__':
    ...
    Scaler_data = Scaler(original_data)
    np.savetxt(Save_path+'/'+Data_name+'_Scaler_'+'data.csv', Scaler_data, delimiter = ',')
